...
private int treinoSelecionadoId = -1; // id do treino que está sendo editado
   ...
   try {
    ...
    treinoSelecionadoId = Integer.parseInt(tblTreino.getValueAt(linha, 0).toString()); // COL_ID
    txtTipoTreino.setText(tblTreino.getValueAt(linha, 1).toString());
    txtDuracaoTreino.setText(tblTreino.getValueAt(linha, 2).toString());
    txtCaloriasTreino.setText(tblTreino.getValueAt(linha, 3).toString());
    txtDataTreino.setText(tblTreino.getValueAt(linha, 4).toString());
